...
void testlibpower_GIVEN_current_THEN_returnPower(void)
{
   ...
   const float power = calv_power_i(volt, current);
...
int main()
{
   CU_libpowerSuite libpowerSuite = NULL;
   ...
   libpowerSuite = CU_add_suite("Suite_1", init_suite1, clean_suite1);
   ...
   if ((NULL == CU_add_test(libpowerSuite, "test of fprintf()", testlibpower_GIVEN_current_THEN_returnPower)))
       //||
